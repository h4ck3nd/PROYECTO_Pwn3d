...
<!-- MENU DE HABURGUESA -->
    ...
    <div id="sidebarWrapper" class="sidebar-wrapper open">
      ...
      <!-- Seccion Perfil Usuario -->
      	<a href="<%= request.getContextPath() %>/profile/profile.jsp" style="font-size: 1.3rem !important;">
      ...
      <!-- Seccion Usuarios -->
		...
		<!-- Seccion Reconocimientos paginas -->
      	<a href="<%= request.getContextPath() %>/appreciation.jsp" style="color: #b600ff; text-decoration:none; display:inline-flex; align-items:center; gap:8px; font-size: 1.3rem !important;">
