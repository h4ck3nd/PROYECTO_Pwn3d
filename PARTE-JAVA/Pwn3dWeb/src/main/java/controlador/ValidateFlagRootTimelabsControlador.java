...
import dao.ValidateFlagRootTimelabsDAO;

@WebServlet("/getFlagRootTimelabsCount")
public class ValidateFlagRootTimelabsControlador extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ValidateFlagRootTimelabsDAO dao = new ValidateFlagRootTimelabsDAO(conexion);
