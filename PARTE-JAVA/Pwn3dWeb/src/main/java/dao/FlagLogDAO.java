...
public class FlagLogDAO {
    ...
    public List<FlagLog> getAllLogs() throws Exception {
        ...
        String sql = "SELECT user_id FROM validate_flag ORDER BY id DESC";
    ...
    public List<FlagLog> getLogsByLabId(int labId) throws Exception {
        ...
        String sql = "SELECT user_id FROM validate_flag WHERE lab_id = ? ORDER BY id DESC";
