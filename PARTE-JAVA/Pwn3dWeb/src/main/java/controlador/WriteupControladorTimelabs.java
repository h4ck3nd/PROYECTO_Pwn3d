...
@WebServlet("/WriteupControladorTimelabs")
public class WriteupControladorTimelabs extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean insertado = dao.insertWriteupTimelabs(labId, userId, url, username);
