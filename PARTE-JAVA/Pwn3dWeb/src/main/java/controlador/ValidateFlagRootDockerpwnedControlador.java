...
import dao.ValidateFlagRootDockerpwnedDAO;

@WebServlet("/getFlagRootDockerpwnedCount")
public class ValidateFlagRootDockerpwnedControlador extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ValidateFlagRootDockerpwnedDAO dao = new ValidateFlagRootDockerpwnedDAO(conexion);
